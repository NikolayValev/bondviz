...
.\.venv\Scripts\python.exe -m pip install streamlit matplotlib pandas requests python-dotenv pandas-datareader polygon-api-client streamlit-option-menu scikit-learn || goto :err
echo Done.
exit /b 0
:err
